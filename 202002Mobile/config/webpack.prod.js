...
module.exports =  merge(common, {
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
        filename: "assets200208/css/[name].css",
    ...
    new CopyWebpackPlugin([
    	{ 
    		from: 'src/assets200208/js/lib', 
    		to: path.resolve(__dirname, '../dist/assets200208/js/lib'),
    		force:true
    	},{ 
    		from: 'src/assets200208/fonts', 
    		to: path.resolve(__dirname, '../dist/assets200208/fonts'),
    		force:true
    	},{ 
    		from: 'src/assets200208/img', 
    		to: path.resolve(__dirname, '../dist/assets200208/img'),
    		force:true
    	}
    ])
  ]
