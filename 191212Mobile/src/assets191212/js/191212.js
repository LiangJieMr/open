...
window.onload = function(){
	...
	var ledTime;
	var ledIndex = 0;
	var $activity_rolllight1 = $('.activity_rolllight1');
	var $activity_rolllight2 = $('.activity_rolllight2');
	var $activity_rolllight3 = $('.activity_rolllight3');
	led();
	function led(){
		ledIndex++;
		if(ledIndex > 3){
		...
		if(ledIndex == 1){
			$activity_rolllight1.show();
			$activity_rolllight2.hide();
			$activity_rolllight3.hide();
		}else if(ledIndex == 2){
			$activity_rolllight1.hide();
			$activity_rolllight2.show();
			$activity_rolllight3.hide();
		}else if(ledIndex == 3){
			$activity_rolllight1.hide();
			$activity_rolllight2.hide();
			$activity_rolllight3.show();
		}else{
			$activity_rolllight1.show();
			$activity_rolllight2.hide();
			$activity_rolllight3.hide();
